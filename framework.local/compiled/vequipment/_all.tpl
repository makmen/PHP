...
<?  } else {  ?>
<form action="http://framework.local/vequipment/all" method="post"  class="cmxform">
<div class="account">
...
<? if (is_array(compiler::getInstance()->vars["vequipment"]) && count (compiler::getInstance()->vars["vequipment"])>0) {reset(compiler::getInstance()->vars["vequipment"]); while (list(compiler::getInstance()->vars["k"], compiler::getInstance()->vars["v"]) = each(compiler::getInstance()->vars["vequipment"])) {  ?>
<div class="ambitios_p4">
    ...
    <div class="ambitios_wrapper">
            <a href="http://framework.local/vequipment/view/<? echo compiler::getInstance()->vars["v"]['id']; ?>" class="ambitios_button_small_rev ambitios_fleft">Просмотреть</a>
    </div>
</div>
<?  } }  ?>
    ...
    <? if (is_array(compiler::getInstance()->vars["pagging"]) && count (compiler::getInstance()->vars["pagging"])>0) {reset(compiler::getInstance()->vars["pagging"]); while (list(compiler::getInstance()->vars["k"], compiler::getInstance()->vars["v"]) = each(compiler::getInstance()->vars["pagging"])) {  ?>
        <a href="http://framework.local/vequipment/all?p=<? echo compiler::getInstance()->vars["v"]; ?>" <? if ( compiler::getInstance()->vars["page"] == compiler::getInstance()->vars["v"]) { ?>class="currentpagging"<?  }  ?>><? echo compiler::getInstance()->vars["v"]; ?></a>&nbsp;
    <?  } }  ?>
</div> 
    <?  }  ?>
<?  } else {  ?>
