...
<?  } else {  ?>
<form action="http://framework.local/article/technology" method="post"  class="cmxform">
<div class="account">
...
<div class="ambitios_indent_left ambitios_picture"><img src="http://framework.local/images/tech.jpg" alt="" /></div>
