      ...
      <div class="ambitios_wrapper">
        <div class="ambitios_grid_11 ambitios_alpha">
            ...
            <?php if ($this->out["module"] == ''): ?>
                ...
                <p>
                    Система представляет из себя решение для шифрования с помощью метода с автоключом при использовании 
                ...
                <p class="ambitios_p3">
                    ...
                    Количество файлов не ограничено, но лимит файлов не более 10 Мб. Если поместить больше, будет задержка по времени.
                    Чтобы зашифровать файлы, необходим открытый ключ, с помощью которого будет происходить шифрование.
                    Ключ должен содержать от 10 до 30 символов.
                </p>
                <p class="ambitios_p3">
                    ...
                    Полученные файлы можно передавать по разным источником информации (например три файла вы можете передать по skype, еще три по email, по viber и т.д) 
                </p>
                <p> 
                    ...
                    Если ключ будет неверный, то системf также не расшифрует изначальные файлы. 
                    Расшифрованые файлы будут находиться в директории files/decode в zip архиве.
                </p>
                <p> 
                    Необходимое ПО:
                </p>
