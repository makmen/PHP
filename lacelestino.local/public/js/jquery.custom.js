...
jQuery( document ).ready( function( $ ) {
    ...
    //Contact form labels
    $( '.contact-form [type="text"], form input[type="password"], .contact-form textarea' ).focus( function() {
        //Hide label
        $( this ).parents( 'li' ).find( 'label' ).hide(); 
    } );
    
    $( '.contact-form [type="text"], form input[type="password"], .contact-form textarea' ).blur( function() {
        //Show label
        if( $( this ).val() == '' )
